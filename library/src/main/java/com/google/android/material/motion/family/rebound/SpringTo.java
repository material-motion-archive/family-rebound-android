...
/**
 * Pull a view's {@link ReboundProperty property} towards a specific value using a {@link Spring
 ...
 */
public class SpringTo<V> extends ObjectSpringTo<View, V> {

  /**
   * Initializes a SpringTo plan for the property with a destination.
   */
  public SpringTo(ReboundProperty<? super View, V> property, V destination) {
    super(property, destination);
  }
}
